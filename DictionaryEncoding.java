...
public class DictionaryEncoding
{
    ...
    public static void main(String[] args)
    {
        ...
        for (String word : dictionary.keySet()){
            if (dictionary.get(word) > highestFrequency){
                highestFrequency = dictionary.get(word);
                mostCommonWord = word;	
            }
        ...
        System.out.println("The most common word is " + mostCommonWord + " at " + highestFrequency);
    }
}
